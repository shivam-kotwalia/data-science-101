...
#vectors-single row multiple column
#dataframe-one column multiple rows


### YML algorithm
1.supervised-when u know what we want to calculate and what data is given
2.unsupervised- when u dont know what we calculate we get result by making clusters,in this we never tell the answer

#supervised-a)classification
            b)Regression
...
iris_cluster$size
			...
			Euclidean distanc-its a hypotenuse only
			
dendrogram-It is subset of clusters.			
